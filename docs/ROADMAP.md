...
Full rationale and review-fix history for PR5 through PR8 (PR8C slice): `docs/DECISION_LOG.md`. PR21, PR22-PR25, and PR30 (GitHub PR numbers) are process/documentation-only additions with no code, business-rule, or schema change — no `DECISION_LOG.md` entry was needed for them. PR8A/PR8B/PR8C (GitHub PR #26, #28, #29, #31) are different: they are production code changes and do have `DECISION_LOG.md` entries.
