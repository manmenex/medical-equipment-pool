...
Roadmap PR7 (both slices, GitHub PR #19/#20) is the most recent *fully completed* Roadmap-numbered item. Within Roadmap PR8: PR8A is complete (GitHub PR #26), PR8B is complete (GitHub PR #28 backend + #29 frontend), and PR8C is not started. **Roadmap PR8 as a whole remains incomplete until PR8C merges.** See `knowledge/adr/ADR-005-transaction-model.md`, `docs/DOMAIN_MODEL.md`, and `docs/DECISION_LOG.md` for PR7, PR8A, and PR8B.
